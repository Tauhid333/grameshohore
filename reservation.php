...
<body>
    ...
    <div class="container">
       ...
       <div class='row ' style="margin-top:80px;margin-bottom:67px;">
        ...
        <div class='col-md-5 well1'>
         <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
                    ...
                    <input type="form-control form-control-lg" class="datepicker" name="checkin">

                </div>
               
               <div class="form-group">
                    <label for="checkout">Check Out:</label>&nbsp;&nbsp;
                    <input type="form-control form-control-lg" class="datepicker" name="checkout">
                </div>
                 
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" class="btn btn-primary button" name="submit">Availability</button>
